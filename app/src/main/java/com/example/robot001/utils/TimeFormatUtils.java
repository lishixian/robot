...
public class TimeFormatUtils {
    ...
    public static String timeFormatYMDHM(long time) {
        return new SimpleDateFormat("yyyy-MM-dd HH:mm").format(new Date(time));
    }
    public static String timeFormatYMDHM2(long time) {
        return new SimpleDateFormat("yyyy/MM/dd HH:mm").format(new Date(time));
    }
    /**
     * 转化为时分秒
...
//        }
     ...
     * @return
     */
    public static String stringToString(String times, String s) {
     ...
     * @return
     */
    public static String timeToTime(String time,String formatTypeIn,String formatTypeTo){
        long l = 0;
        try {
            l = stringToLong(time, formatTypeIn);
            String s = longToString(l, formatTypeTo);
            return s;
        } catch (ParseException e) {
            e.printStackTrace();
        }
